          ...
          <div className="flex space-x-4">
            <button
              ...
              className={`px-4 py-2 rounded-md transition-colors ${
                activeTab === "portfolio" ? "bg-gray-900 text-white" : "bg-white text-gray-700 hover:bg-gray-100"
              }`}
            >
              Portfolio
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md transition-colors ${
                activeTab === "pitch" ? "bg-gray-900 text-white" : "bg-white text-gray-700 hover:bg-gray-100"
              }`}
            >
              New Pitch
            </button>
